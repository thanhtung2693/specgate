...
- **[governance/docs/spec.md](./governance/docs/spec.md)** — governance runtime contract:
  the single governance-chat node, its tools, MCP wiring, and graph boundaries.
- **[governance/docs/event-contract.md](./governance/docs/event-contract.md)** —
  governance-ops-to-UI event and hydration contract.

## Boundaries

- Governance-ops orchestration (readiness gates, delivery review, classification) belongs here.
- The governance-chat surface (thread title) belongs here.
