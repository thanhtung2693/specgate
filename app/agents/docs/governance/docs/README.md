...
1. **[spec.md](./spec.md)** — governance runtime contract. Covers the single
   governance-chat node, its governance-op tools, state fields, MCP wiring, and
...
(e.g. `../../../../ui/src/components/governance-chat/`). Runbook-style scenario
coverage lives in [docs/testing.md](../../../../docs/testing.md).
