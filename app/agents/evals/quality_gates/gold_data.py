...
Defines per-gate gold fixtures for the single-verdict LLM quality gates judged by
...
CI runs these against a fake judge that returns the fixture's intended
