...
The CI path is deterministic: a fixture judge returns each fixture's intended
...
def test_harness_covers_every_verdict_gate() -> None:
    # The harness must evaluate every model-judged gate except the documented exclusion;
...
# ---------------------------------------------------------------------------
# Live calibration — real model judge (opt-in via GOVERNANCE_LIVE_SMOKE=1)
# ---------------------------------------------------------------------------
