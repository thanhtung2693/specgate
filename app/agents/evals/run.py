...
# Per-row USD cost estimate for each target. The contract targets default to
# the fixture judge (zero cost); the live judge mode calls the settings-backed
# governance model once per row. The cost guard multiplies these by the row
# count selected and aborts before tokens are spent when the total exceeds
# --cost-cap.
...
def parse_args(argv: list[str] | None = None) -> argparse.Namespace:
    ...
    parser.add_argument(
        ...
        default="fixture",
        help=(
            "Judge mode for contract targets. fixture=deterministic CI baseline, "
