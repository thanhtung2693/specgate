...
type Thread struct {
	...
	WorkspaceID string    `gorm:"column:workspace_id;index:idx_governance_threads_workspace_archived_updated"`
...
type Store interface {
	...
	Delete(ctx context.Context, workspaceID, threadID string, now time.Time) error
}
