...
// AllowedGovernanceUploadContentType returns whether the MIME type may use governance presigned uploads.
func AllowedGovernanceUploadContentType(contentType string) bool {
	...
	switch c {
	case "application/pdf", "text/markdown", "text/x-markdown", "text/plain":
		return true
	default:
		return false
	}
