...
export type GeneralSettingsData = {
  "governance.auto_feature_summary": "true" | "false"
  ...
  "governance.lifecycle_confidence_threshold": string
}

export type EditableGeneralSettingsData = Pick<
  GeneralSettingsData,
  | "governance.auto_feature_summary"
...
export const defaultGeneralSettings: GeneralSettingsData = {
  ...
  "governance.lifecycle_confidence_threshold": "0.7",
}

export function normalizeGeneralSettings(settings?: Record<string, string>): GeneralSettingsData {
  return {
    ...defaultGeneralSettings,
    "governance.auto_feature_summary": settings?.["governance.auto_feature_summary"] === "false" ? "false" : "true",
    ...
    "governance.lifecycle_confidence_threshold":
      settings?.["governance.lifecycle_confidence_threshold"] || defaultGeneralSettings["governance.lifecycle_confidence_threshold"],
  }
}

export function editableGeneralSettings(settings: GeneralSettingsData): EditableGeneralSettingsData {
  return {
    "governance.auto_feature_summary": settings["governance.auto_feature_summary"],
